...
Sub SolveAndPlotEquations()
    ...
    With cht.Chart
        ...
        .SeriesCollection(2).MarkerStyle = xlMarkerStyleNone  ' Remove markers (optional)
        .SeriesCollection(2).Format.Line.Weight = 2  ' Set line width to 2 points (adjust as needed)
